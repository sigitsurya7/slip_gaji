...
import { ReactComponent as WhatsAppIcon } from "./whatsapp-icon.svg?react";
import { ReactComponent as PdfIcon } from "./pdf-icon.svg?react";
import { ReactComponent as ExcelIcon } from "./excel-icon.svg?react";
